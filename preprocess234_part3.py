...
if __name__ == "__main__":
    ...
    train_features234 = preprocessForAll234('../../dataset/train.csv', pathString, 20718, 31071)
    writeToCSV('../../output/train_features234_part3.csv', headerName, train_features234)
