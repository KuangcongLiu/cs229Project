...
if __name__ == "__main__":
    ...
    train_features234 = preprocessForAll234('../../dataset/train.csv', pathString, 10359, 20717)
    writeToCSV('../../output/train_features234_part2.csv', headerName, train_features234)
