...
def preprocessForAll234(directory_in_str):
    ...
    for file in os.listdir(directory):
        ...
        if "green" in filename:
            ...
            features = preprocessForFeature234(directory_in_str, graph_id)
            graph_dict[graph_id] = features
            print("Graph", i, "Features234: ", features, " Time now: "+ str(datetime.now()))
            i += 1
...
if __name__ == "__main__":
    ...
    train_features234 = preprocessForAll234(pathString)
    writeToCSV('../../output/train_features234.csv', headerName, train_features234)
    pathString = "../../dataset/test"
    test_features234 = preprocessForAll234(pathString)
    writeToCSV('../../output/test_features234.csv', headerName, test_features234)
